...
import { Database, BarChart3, Code2, Server, Globe, Terminal, LucideIcon, LineChart, ShoppingBag, Wallet } from 'lucide-react';
  ...
  projects: [
    {
      ...
      tech: ["Kafka", "Apache Spark", "Cassandra", "Docker"],
      year: "2024",
      category: "Data Engineering",
      ...
      description: [
        ...
        "Implemented a Cassandra sink for high-throughput write operations, handling 10,000+ events per second.",
        "Containerized the entire infrastructure using Docker Compose for seamless deployment and reproducibility."
      ]
    },
    {
      ...
      icon: "ShoppingBag",
      description: [
        "Deployed web scraping solution to extract 200+ personal orders over 2 years from Swiggy platform.",
        "Constructed interactive dashboard visualizing key metrics: most-ordered restaurants, spend trends, and cuisine preferences."
      ]
    },
    {
      ...
      icon: "Wallet",
      description: [
        "Developed automation script with session-based authentication to extract inventory and sales data from myBillBook.",
        "Monitored INR 1M+ inventory across 400+ products for real-time business performance visibility."
      ]
    }
  ],
  education: [
